...
function Leadership({fb,ig,x,ln}) {
  return (
    <section className="Leaders">
      ...
      <div className="ourleaders">
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="dr John ndia" />
          <h1>Dr. John Ndia</h1>
          <p>
        ...
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="Victory Njeri" />
          <h1>Victory Njeri</h1>
          <p>
        ...
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="allan" />
          <h1>Allan Muhari</h1>
          <p>
        ...
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="bridget" />
      ...
      <div className="ourleaders">
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="Ruth Mutisya" />
          <h1>Ruth Mutisya</h1>
          <p>
        ...
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="Webster Ifedha" />
        ...
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="Manase Gunga" />
          <h1>Manase Gunga</h1>
          <p>
        ...
        <div className="ndia">
          <img src="../src/assets/ndia.jpg" alt="Carolyne Githenduka" />
